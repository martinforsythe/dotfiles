...
class JupyterClientAdapter extends events_1.EventEmitter {
    ...
    dispose() {
        try {
            this.ipythonAdapter.sendKernelCommand(this.lastStartedKernelUUID, contracts_1.KernelCommand.shutdown);
        }
        catch (ex) {
        }
        try {
    ...
    startSocketServer() {
        ...
        this.ipythonAdapter = new jupyterSocketClient_1.JupyterSocketClient(this.socketServer);
