...
function activate(context) {
    ...
    try {
        ...
        context.subscriptions.push(new exportCurrent_1.CommandExportCurrent(), new exportDocument_1.CommandExportDocument(), new exportWorkspace_1.CommandExportWorkspace(), new urlCurrent_1.CommandURLCurrent(), new urlDocument_1.CommandURLDocument(), new previewStatus_1.CommandPreviewStatus(), new extractSource_1.CommandExtractSource(), new formatter_1.Formatter(), new symboler_1.Symbol(), new diagnoser_1.Diagnoser(ext), previewer_1.previewer, config_1.config, common_1.outputPanel, common_1.bar);
        return {
            extendMarkdownIt(md) {
