...
function activate(ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // push
        new validate_1.ValidateCommand(indexAdapter, runner), new lint_1.LintCommand(), new reindex_1.ReindexCommand(indexAdapter, watcher), new showreferences_1.ShowReferencesCommand(indexAdapter), new commands_1.IndexCommand(indexAdapter), new preview_1.PreviewGraphCommand(graphProvider, indexAdapter, runner), new navigatetosection_1.NavigateToSectionCommand(indexAdapter), 
        // providers
