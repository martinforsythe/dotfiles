...
class PreviewGraphCommand extends command_1.Command {
    constructor(provider, index, runner) {
        super("preview-graph");
    ...
    perform() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield vscode.commands.executeCommand('vscode.previewHtml', graph_1.graphPreviewUri, vscode.ViewColumn.Active, 'Terraform Graph');
            }
            catch (error) {
