    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < installedExtensions.length; i++) {
            ...
            if (extension.id === 'ms-vscode.azure-account') {
                try {
                    azureAccount = yield extension.activate();
                }
                catch (error) {
        ...
        ctx.subscriptions.push(vscode.commands.registerCommand('vscode-docker.compose.restart', docker_compose_1.composeRestart));
        ...
        ctx.subscriptions.push(vscode.commands.registerCommand('vscode-docker.browseDockerHub', (context) => {
            dockerHubUtils_1.browseDockerHub(context);
        }));
        ctx.subscriptions.push(vscode.commands.registerCommand('vscode-docker.browseAzurePortal', (context) => {
