...
function dockerHubLogout() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (keytar) {
            yield keytar.deletePassword('vscode-docker', 'dockerhub.token');
            yield keytar.deletePassword('vscode-docker', 'dockerhub.password');
            yield keytar.deletePassword('vscode-docker', 'dockerhub.username');
        }
        _token = null;
    });
}
