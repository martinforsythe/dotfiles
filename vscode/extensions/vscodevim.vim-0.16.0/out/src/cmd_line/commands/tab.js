                ...
                case Tab.Absolute:
                    if (this._arguments.count /** not undefined or 0 */) {
                        if (this._arguments.count <= 9) {
                            ...
                            yield vscode.commands.executeCommand('workbench.action.openEditorAtIndex9');
                            yield this.executeCommandWithCount(this._arguments.count - 9, 'workbench.action.nextEditorInGroup');
                        }
                    }
                    break;
                case Tab.Next:
